 ...
 *
 */
class BuyerController extends Admin_Controller
{
    ...
    public function index($user_id = null)
    {
        ...
        $this->data['addBank']          = "buyer/addBank";
        $this->data['editBank']         = "buyer/editBank";
        $this->data['deleteBank']       = "buyer/deleteBank";

        $this->data['addMobileBank']    = "buyer/addMobileBank";
        $this->data['editMobileBank']   = "buyer/editMobileBank";
        $this->data['deleteMobileBank'] = "buyer/deleteMobileBank";

        $this->data['addEwallet']       = "buyer/addEwallet";
        $this->data['editEwallet']      = "buyer/editEwallet";
    ...
    public function add_bank($user_id = null)
    {
        ...
        if($this->form_validation->run()){
            ...
            redirect(base_url('buyer/'.$user_id));
        }

        $this->data['action']    = "buyer/addBank";
        $this->data['user_id']    = $user_id;
    ...
    public function edit_bank($user_id = null , $bank_id = null)
    {
        ...
        $this->data['action']    = "buyer/editBank";
        $this->data['user_id']    = $user_id;
    ...
    public function add_ewallet($user_id = null)
    {
        ...
        $this->data['action']    = "buyer/addEwallet";
    ...
    public function edit_ewallet($user_id = null , $ewallet_id = null)
    {
        ...
        $this->data['action']    = "buyer/editEwallet";
        $this->data['user_id']    = $user_id;
    ...
    public function add_mobile_bank($user_id = null)
    {
        ...
        $this->data['action']    = "buyer/addMobileBank";
    ...
    public function edit_mobile_bank($user_id = null , $mobile_bank_id = null)
    {
        ...
        $this->data['action']    = "buyer/editMobileBank";
        $this->data['user_id']    = $user_id;
    ...
    public function edit_personal_identity($user_id = null,$pi_id = null)
    {
        ...
        $this->data['pi']      = $pi;
        $this->data['action']  = "buyer/personalIdentity";
        $this->data['user_id'] = $user_id;
    ...
    public function edit_proof_of_address($user_id = null,$proof_id = null)
    {
        ...
        $this->data['action']  = "buyer/proofOfAddress";
        $this->data['user_id'] = $user_id;

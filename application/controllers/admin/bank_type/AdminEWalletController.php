...
class AdminEWalletController extends Admin_Controller {
    ...
    public function ewallet() {
        ...
        if($this->form_validation->run()){
            if ($this->e_wallet_type_m->add_ewallet()) {
        ...
        $this->data['ewallets'] = $this->e_wallet_type_m->get();
    ...
    public function update_ewallet($ewallet_id)
    {
        ...
        if($this->form_validation->run()){
            if ($this->e_wallet_type_m->update_ewallet($ewallet_id)) {
        ...
        $this->data['ewallet'] = $this->e_wallet_type_m->get($ewallet_id);
    ...
    {
        if ($this->e_wallet_type_m->delete($ewallet_id)) {

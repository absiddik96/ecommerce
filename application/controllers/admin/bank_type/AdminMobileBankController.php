...
class AdminMobileBankController extends Admin_Controller {
    ...
    public function mobile_bank() {
        ...
        if($this->form_validation->run()){
            if ($this->mobile_bank_type_m->add_mobile_bank()) {
        ...
        $this->data['mobile_banks'] = $this->mobile_bank_type_m->get();
    ...
    public function update_mobile_bank($mobile_bank_id)
    {
        ...
        if($this->form_validation->run()){
            if ($this->mobile_bank_type_m->update_mobile_bank($mobile_bank_id)) {
        ...
        $this->data['mobile_bank'] = $this->mobile_bank_type_m->get($mobile_bank_id);
    ...
    {
        if ($this->mobile_bank_type_m->delete($mobile_bank_id)) {

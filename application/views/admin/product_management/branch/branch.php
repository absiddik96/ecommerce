...
<div class="page-content-wrap">
    <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-name">Add Branch</h3>
                    </div>
                    <div class="panel-body">
                        ...
                        <?php } ?>
                        <div class="col-md-5">
                            <form method="post" action="<?php echo base_url('admin/branch') ?>" class="form-horizontal" role="form" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input name="branch_name" class="form-control" type="text" placeholder="Enter Branch Name">
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">List of Branch</h3>
                </div>
                <div class="panel-body">
                            ...
                            if (!empty($branchs)):
                                foreach ($branchs as $branch):
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $branch->division_state_name; ?></td>
                                        <td><?php echo $branch->district_city_name; ?></td>
                                        <td><?php echo $branch->upazila_ps_name; ?></td>
                                        <td><?php echo $branch->union_word_name; ?></td>
                                        <td><?php echo $branch->village_moholla_name; ?></td>
                                        <td><?php echo $branch->branch_name; ?></td>
                                        <td>
                                            <a href="<?php echo base_url('admin/updateBranch/' . $branch->id); ?>" class="btn  btn-primary"><i class="fa fa-lg fa-edit"></i></a>
                                            <button type="button" class="btn btn-danger" data-toggle="modal" data-target="<?php echo '#' . $branch->id; ?>"><i class="glyphicon glyphicon-trash"></i></button>
                                            <!---------------------- delete Pop Up ----------------------------->
                                            <div class="modal fade" id="<?php echo $branch->id; ?>" role="dialog">
                                                <div class="modal-dialog modal-sm">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <a href="<?php echo base_url('admin/deleteBranch/' . $branch->id); ?>" class="btn btn-danger">Yes</a>

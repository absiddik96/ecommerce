    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">List of User Sub Type</h3>
                    </div>
                    <div class="panel-body">
                                    ...
                                    foreach ($sub_types as $sub_type):
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button type="button" class="btn btn-danger" data-toggle="modal" data-target="<?php echo '#' . $sub_type->id; ?>"><i class="glyphicon glyphicon-trash"></i></button>
                                                <!---------------------- delete Pop Up ----------------------------->
                                                <div class="modal fade" id="<?php echo $sub_type->id; ?>" role="dialog">
                                                    <div class="modal-dialog modal-sm">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                <p >Are you want to delete this User Sub Type?</p>
                                                                <a href="<?php echo base_url('admin/deleteUserSubType/' . $sub_type->id); ?>" class="btn btn-danger">Yes</a>

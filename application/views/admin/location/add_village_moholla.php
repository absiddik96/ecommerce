            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-name">Add Village / Moholla</h3>
                    </div>
                    <div class="panel-body">
                        ...
                        <?php } ?>
                        <div class="col-md-5">
                            <form method="post" action="<?php echo base_url('admin/addVillageMoholla') ?>" class="form-horizontal" role="form" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input name="village_moholla_name" class="form-control" type="text" placeholder="Enter Village / Moholla">

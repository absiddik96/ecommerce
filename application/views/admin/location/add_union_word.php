            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-name">Add Union / Word</h3>
                    </div>
                    <div class="panel-body">
                        ...
                        <?php } ?>
                        <div class="col-md-5">
                            <form method="post" action="<?php echo base_url('admin/addUnionWord') ?>" class="form-horizontal" role="form" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label class="col-md-4 control-label">Union / Word Name</label>
                                    <div class="col-md-8">
                                        <input name="union_word_name" class="form-control" type="text" placeholder="Enter Union / Word">

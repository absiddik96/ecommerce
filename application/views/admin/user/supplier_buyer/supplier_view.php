                    ...
                    <?php foreach ($users as $admin): ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <?php else: ?>
                                    <a href="<?php echo site_url('admin/userAdminActive/').urlencode($admin->user_id).'/supplierList';?>" class="btn btn-sm btn-success">Active</a>
                                <?php endif; ?>
                                <a href="<?php echo site_url('admin/userAdminDelete/').urlencode($admin->user_id).'/supplierList';?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to delete this users.'/supplierList'?');">Delete</a>
                            </td>
                        </tr>
                    <?php endforeach;?>
                <?php endif; ?>
